...
static unsigned int sqlctx = 42467;
...
{12,4130,1,0,0,
5,0,0,1,0,0,27,45,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,10,0,0,1,10,0,0,
...
/* EXEC SQL BEGIN DECLARE SECTION; */ 
	...
	/* VARCHAR bulb[1000]; */ 
struct { unsigned short len; unsigned char arr[1000]; } bulb;

   /* VARCHAR unix_uid[20]; */ 
struct { unsigned short len; unsigned char arr[20]; } unix_uid;

   /* VARCHAR unix_pwd[20]; */ 
struct { unsigned short len; unsigned char arr[20]; } unix_pwd;
...
sql_connect()
{
  strcpy(unix_uid.arr,s02_orauid);
  strcpy(unix_pwd.arr,s02_orapwd); 
  unix_uid.len = strlen(unix_uid.arr);
  unix_pwd.len = strlen(unix_pwd.arr);
...

{
  ...
  sqlstm.sqhstv[0] = (unsigned char  *)&unix_uid;
  ...
  sqlstm.sqhstv[1] = (unsigned char  *)&unix_pwd;
